...
<td width="25%">
             ...
             <div class="nanan" id="mamam">
               <div ex:role="facet" ex:expression=".wet" ex:height="60px"  ex:showMissing="false" ex:facetLabel="<? echo $tongue['textile_finishing_wet_dry']; ?>"></div>
                   <br><span> <h3> <? echo $tongue['textile_finishing_please_continue']; ?></h3> </span><br>
               <div ex:role="facet" ex:expression=".Fabric" ex:showMissing="false" ex:height="100px" ex:collapsed="false" ex:facetLabel="<? echo $tongue['textile_finishing_fabric']; ?>"></div>
               <div ex:role="facet" ex:expression=".ps" ex:showMissing="false" ex:collapsed="false"  ex:height="200px" ex:facetLabel="<? echo $tongue['textile_finishing_problem_solver']; ?>"></div>
               <div ex:role="facet" ex:expression=".Machine"  ex:showMissing="false" ex:collapsed="false" ex:facetLabel="<? echo $tongue['textile_finishing_machine_style']; ?>"></div>
               ...
               <div ex:role="facet" ex:expression=".Fabric Weight"  ex:showMissing="false" ex:collapsed="false" ex:facetLabel="<? echo $tongue['textile_finishing_fabric_weight']; ?>"></div>
