...
define('follow', 'widget_globalstores.php?'.$_COOKIE['tmpagent'].'&choice='.$_COOKIE['tmpchoice'].'&store='.$rabbithole.'&key=configuration');
/*
...
require('merrow_global_login.config.php');
require('merrow_global_login.lang.php');
require('merrow_global_login.class.php');
