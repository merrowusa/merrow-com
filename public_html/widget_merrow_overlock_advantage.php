...
<div class="cp_title">Merrow Machine Advantages</div>
<div class="line_b"> </div>
<div style="width:100%;height:1px;overflow:hidden"></div><br><div class="headline">HERITAGE</div><br clear="all"/>
...
<br clear="all"/><div style="width:100%;border-top: 1px dashed #999999;margin:18px 0;height:1px;overflow:hidden"></div><br><div class="headline">DURABILITY: </div><br clear="all"/>
...
<br clear="all"/><br clear="all"/>
<img src="http://decorativeedging.s3.amazonaws.com/productpages/cams400pxw_1.jpg" id="cam_pic" width="900" height="345"/>
<div class="margin_container_300">
<ol>
...
<div style="width:100%;border-top: 1px dashed #999999;margin:18px 0;height:1px;overflow:hidden"></div><br><div class="headline">VERSATILITY (for OVERLOCK SEWING):</div><br clear="all"/>
...
With more than 645 different needle plates and feed dogs, we can modify the sitch to accomodate more demanding fabrics <br clear="all"/><br clear="all"/>

<div style="width:100%;border-top: 1px dashed #999999;margin:18px 0;height:1px;overflow:hidden"></div><br><div class="headline">MERROW Will Build you a CUSTOM MACHINE at NO EXTRA COST</div><br clear="all"/>
...
<div style="width:100%;border-top: 1px dashed #999999;margin:18px 0;height:1px;overflow:hidden"></div><br><div class="headline">MERROW parts can be Replaced</div><br clear="all"/>
...
<!--<br clear="all"/><br clear="all"/><b>Get Support Anywhere in the World:156 service providers in 65 countries</b><br clear="all"/>
Just because the machine will last for a lifetime doesn't mean it won't need to be serviced regularly. Merrow has more than 150 dealers supporting continuous processing sewing around the world.
<br clear="all"/><br clear="all"/><b>International Priority Spare Parts Service</b><br clear="all"/>
Merrow Service Providers maintain Merrow spare parts inventory in 22 different locations internationally, including
Shanghai,
Hong Kong,
New Delhi ,
Tirapur,
...
<div class="clear"></div>
<br clear="all"/><br clear="all"/>
<div class="cp_title"> Sales, Support and Service</div>
<div class="line_b"> </div>
...
<div class="headline">SALES</div><br clear="all"/>

<div class="float">
<a href="http://merrow.com/agentmap.html">
<img src="http://merrowservices.s3.amazonaws.com/2010_landingpage/agentmap.png" width="646" height="309"
alt="merrow agent map" />
</a>
</div>
<div class="clear"></div>
<br clear="all"/>
<div style="width:100%;border-top: 1px dashed #999999;margin:18px 0;height:1px;overflow:hidden"></div><br><div class="headline">SUPPORT</div>
...
Enjoy free access to our <a href="http://merrow.com/support.html">support online</a>, our <a href="http://merrow.com/support/class/key/mediakeyword/70d3b2">interactive parts guide</a> and <a href="http://merrow.com/support/class/70/key/setup">detailed operation instructions</a>.

<div style="width:100%;border-top: 1px dashed #999999;margin:18px 0;height:1px;overflow:hidden"></div><br><div class="headline">SERVICE</div>
