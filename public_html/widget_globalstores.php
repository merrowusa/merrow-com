...
if(empty($_SESSION['exp_user']) || @$_SESSION['exp_user']['expires'] < time()) {
	header("location:widget_merrow_global_login.php");	//@ redirect 
} else {
...
$result12 = mysql_query("SELECT * FROM login_auth_global WHERE username='$name'")
or die(mysql_error());
...
<div>
  ...
  <div class="title10">
   Merrow Global Analysis
   </div>
     <div class="internal_list">

        
  <a href="http://merrow.com/global_analysis.php?planet=1" target="mammy">Global Master Products</a><br>
