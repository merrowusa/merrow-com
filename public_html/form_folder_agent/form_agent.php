...
/*
  ...
  | CODE, SCRIPTING, AND/OR functions_agent, INCLUDING, WITHOUT         |
  ...
  | AND/OR functions_agent EVEN IF AUTHOR IS ADVISED OF THE POSSIBILITY |
...
### Grab the functions_agent and known variables
if(file_exists('files/functions_agent.php')) {
    ...
    $user_message = '<div class="results"><p class="error"><strong>Installation Error: The functions_agent file, functions_agent.php, does not exist or cannot be found!</strong></p></div>';
    $form_status  = "nogo";
}
...
?> <div class="privacy" id="policy">  <a href="http://merrow.com/cephei/testpages1/privacy.php"><img src="/nebula/images/privacy_shirt.jpg" alt="privacy" longdesc="http://merrow.com/cephei/testpages1/privacy.php" /></a></div>
<?
