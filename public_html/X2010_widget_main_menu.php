										...
										<tbody>
                        						...
                        						<tr>
                                                    ...
                                                    <img src="http://images.imerrow.com/images/menubar/merrow_tsm21.jpg" alt="" border="0">
                                                     ...
                                                     <? } else { ?><img src="http://merrowservices.s3.amazonaws.com/logo/merrow_tsm29.jpg" alt="Merrow Logo" border="0"> 
                                                    ...
                                                    <a href="http://merrow.com/agentmap.html"><img src="http://images.imerrow.com/images/lilgooglepin.png" alt="help" border="0"><? echo $tongue['menu_agent_map']; ?></a>
					 								...
					 								| 
 													<? if ($agents['store_db_name']!=null) { ?> <a href="http://merrow.com/merrow_global_stores.php?asap=2231020293383445&party_id=<? echo $_GET['party_id']; ?>&choice=<? echo $_GET['choice']; ?>" target="_self" rel="nofollow"><? echo $tongue['menu_agent_login']; ?> <? } else { ?> <a href="http://service.merrow.com/index.php/customer/account/" rel="nofollow">Service Account Login</a><? } ?>
