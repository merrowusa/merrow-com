...
if ( $_SERVER['REQUEST_METHOD'] != "POST") {
    ...
    $recipient = "cs@merrow.com";
    $subject = "Merrow INNOVATION Contact Form {$_POST['name']}";
    
    $message = "A message from the Merrow Innovation...: \n";
    $message .= "Name: {$_POST['name']} \n";
    $message .= "E-mail: {$_POST['email']} \n";
  
    $message .= "Message: {$_POST['message']} \n";
    
    $headers = "From: Innovation Contact Form <$recipient> \n";
