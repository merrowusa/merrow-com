<?php
$rabbithole = $_GET['rabbithole']; //we're not using this variable as of 1/19/09
define('follow', 'widget_agent_dashboard.php?'.$_COOKIE['tmpagent'].'&choice='.$_COOKIE['tmpchoice'].'&store='.$rabbithole.'&key=configuration');
/*
...
require('merrow_agent_login.config.php');
require('merrow_agent_login.lang.php');
require('merrow_agent_login.class.php');
