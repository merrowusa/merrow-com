...
//   function db_class($db='merrowco_BOM', $host='localhost', $user='merrowco_bom', $pw='banjo1') {
function db_class($db='merrowco_opentaps', $host='localhost', $user='merrowco_opentap', $pw='ofbiz') {   
...
// 	echo "<p>SELECT: $sql</p>";
   ...
   function select_one($sql) {
	...
	$this->last_error = "Your query, \"$sql\", in function select_one() returned no results.";
	return false;
      }
   ...
   function print_last_query() {
      ...
      <div style="border: 1px solid blue; font-size: 9pt; font-family: monospace; color: blue; padding: .5em; margin: 8px; background-color: #E6E5FF">
         <span style="font-weight: bold">Last SQL Query:</span><br><?= str_replace("n", '<br>', $this->last_query) ?>
      </div>
      <?  
   }
} 
