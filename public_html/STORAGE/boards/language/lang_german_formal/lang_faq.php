...
$faq[] = array("Wie kann ich verhindern, dass mein Name in der 'Wer ist online?'-Liste auftaucht?", "In Ihrem Profil befindet sich die Option <i>Online-Status verstecken</i>, und wenn Sie diese aktivieren, können Sie nur noch von Administratoren in der Liste gesehen werden. Sie zählen dann als versteckter User.");
$faq[] = array("Ich habe mein Passwort verloren!", "Kein Problem! Sie können ein neues Passwort anfordern. Klicken Sie dazu auf der Loginseite auf <u>Ich habe mein Passwort vergessen</u>. Folgen Sie den Anweisungen und Sie sollten sich bald wieder einloggen können.");
...
$faq[] = array("Darf ich HTML benutzen?", "Das hängt davon ab, ob es vom Administrator erlaubt wurde. Falls Sie es nicht dürfen, werden Sie nachher nur ein Klammer-Wirrwarr wieder finden. Dies ist eine <i>Sicherung</i>, um Leute davon abzuhalten, das Forum mit unnötigen Tags zu überschwemmen, die das Layout zerstören oder andere Störungen hervorrufen können. Falls HTML aktiviert wurde, können Sie es immer noch manuell für jeden Beitrag deaktivieren, indem Sie beim Schreiben die entsprechende Option aktivieren.");
...
$faq[] = array("Wie kann ich einer Benutzergruppe beitreten?", "Um einer Benutzergruppe beizutreten, klicken Sie auf den Benutzergruppen-Link im Menü. Sie erhalten dann einen Überblick über alle Benutzergruppen. Nicht alle Gruppen haben <i>offenen Zugang</i>, manche sind geschlossen und andere könnten versteckt sein. Falls die Gruppe neue Mitglieder zulässt, können Sie eine Mitgliedschaft beantragen, indem Sie auf den Beitreten-Button klicken. Der Gruppenmoderator muss noch seine Zustimmung geben; eventuell gibt es Rückfragen, warum Sie der Gruppe beitreten möchten. Bitte belästigen Sie die Gruppenmoderatoren nicht, nur weil sie Sie nicht in die Gruppe aufnehmen wollen. Sie werden ihre Gründe haben.");
