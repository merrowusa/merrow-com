...
//
$faq[] = array("--", "Giriş");
$faq[] = array("BBCode nədir?", "BBCode HTML-ın xüsusi bir təzahürüdür. Foruma yazdığınız ismariclarda BBCode istifadə etmə imkanını idarəçi tə`min edir. Onlar BBCode və ya HTML-ə ayrı-ayrılıqda, ya da hər ikisinə də birdən icazə verə bilərlər. Siz bunu öz `şəxsi mə`lumat`larınız səhifəsindən də yoxlaya bilərsiniz. Orda BBcode və HTML istifadəsi barədə ayrı-ayrılıqda sual verilmişdir. Həm də ismaric göndərmə səhifəsindəki xüsusiyyətlər sayəsində istədiyiniz zaman BBCode-nu ləğv edə bilərsiniz. ismarıc lövhəsində cavab verdiyiniz hissənin altında bu sualla qarşılaşacaqsınız. BBCode HTML-ə bənzər tərzdədir, sadəcə təqlər &lt; və &gt; yerinə [ və ] arasına alınır və nəyin necə göründüyünə daha yaxşı nəzarət etmək olur. ismarıclarınıza BBCode daxil etmək üçün ismaric lövhəsinin üzərində olan təqləri istifadə etməyiniz işi daha da asanlaşdırır (hansı təqlərin seçilməsi sizin mətnə və ifadə etmək istədiyiniz fikrə bağlıdır). Bu mövzuda aşağıdakı rəhbərdən faydalana bilərsiniz. Kiçik bir qeydlə işinizi asanlaşdırmaq istərdim, təqləri ayrı-ayrılıqda hər hansı mətn parçasının başında və sonunda yerləşdirmək sizi çaşdırmasın deyə, qalın, maili, altından xətt çəkilmiş və ya rəngli bir mətni yazmaq üçün, hətta istənilən digər funksiyanı istifadə etmək üçün əvvəlcədən həmin mətn hissəsini ayırıb (select) və istifadə etmək istədiyiniz funksiyanı ifadə edən təqə vura bilərsiniz. Bu sizə almaq istədiyiniz nəticəni tə`min edəcəkdir.");
...
$faq[] = array("Sitat ilə cavab yazma", "Bir mətndən sitat almağın iki müxtəlif yolu var: qaynaq verərək və ya verməyərək.<ul><li>Bir ismarica cavab vermək üçün `Sitat ilə cavab` funksiyasından istifadə edin, orijinal ismaricın sizin ismarica <b>[quote=\"\"][/quote]</b> təqləri arasında daxil olduğunu görəcəksiniz. Bu üsul bir şəxsi və ya seçəcəyiniz hər hansı başqa bir yeri qaynaq verəcəkdir. Məsələn, Əli adlı bir adamın yazdığına şərh vermək üçün bu şəkildə yazmalısınız: <br /><br /><b>[quote=\"Qasım\"]</b>Qasımın yazdığı yazılar...<b>[/quote]</b><br /><br />Nəticədə sitatın qarşısına avtomatik olaraq \"<b>Qasım yazıb:</b>\" yazılır. Sitat gətirdiyiniz şəxsin adını dırnaq işarələri (\"...\") içinə almağı unutmayın, dırnaq işarəsi istifadə etməyiniz <b>şərtdir</b>.</li><br><br><li>İkinci üsul qaynaq vermədən sitat gətirməyiniz üçündür. Seçdiyiniz mətni <b>[quote][/quote]</b> təqləri içinə almanız kifayətdir. Mətnin qarşısında Sitat: yazısını görəcəksiniz.</li></ul>");
...
$faq[] = array("Ayrı bir sayta keçid göymaq", "BBCode keçid (URL) yaratmaq üçün müxtəlif üsulları dəstəkləyir:<ul><li>Birinci üsul <b>[url=][/url]</b> təqləridir. Bərabərlik işarəsinin arxasına yazılanlar keçid olaraq işləyir. Məsələn, mozalan.org-a keçid qoymaq üçün bu şəkildə yazın:<br /><br /><b>[url=http://mozalan.org/]</b>mozalan.org-u ziyarət edin!<b>[/url]</b><br /><br />Nəticədə bu keçidi görəcəksiniz: <a href=\"http://mozalan.org/\" target=\"_blank\">mozalan.org-u ziyarət edin!</a> Bu keçidi açdıqda ayrı bir pəncərə açılır. Bu halda istifadəçi forumda gəzməyə davam edə bilir.</b><br /><br /></li><li>Keçid ünvanının göstərilməsini istiyirsinizsə, bu şəkildə yaza bilərsiniz:<br /><br /><b>[url]</b>http://mozalan.org/<b>[/url]</b><br /><br />Nəticədə bunu görəcəksiniz: <a href=\"http://mozalan.org/\" target=\"_blank\">http://mozalan.org/</a></li></b><br><br><li>phpBB əlavə <b>Sehirli keçidlər</b> deyə bir funksiyaya malikdir. Bunun sayəsində uyğun olaraq yazılan hər sayt ünvanı avtomatik olaraq keçidə çevrilir, hər hansı bir təq, hatta http:// yazmanıza ehtiyac yoxdur. Məs. www.mozalan.org yazdıqda, səhifədə avtomatik olaraq<a href=\"http://mozalan.org/\" target=\"_blank\"> www.mozalan.org</a> görünür.</li></b><br /><br /><li>Eyni funksiya e-məktub ünvanları üçün də olur. İstədiyiniz halda ünvan yazmağınız vacib deyil, məs.:<br /><br /><b>[email]</b>mozalan@mozalan.org<b>[/email]</b><br /><br />yazdıqda belə görünür: <a href=\"mailto:mozalan@mozalan.org\">mozalan@mozalan.org</a> və ya sadəcə mozalan@mozalan.org yaza bilərsiniz və ismarışınız göründükdə bu avtomatik olaraq keçidə çevrilir.</li></ul>Bütün BBCode təqləri kimi, keçid ünvanları da diğər təqlərin içinə daxil edilə bilər, məs.: <b>[img][/img]</b> (bir sonrakı maddəyə baxın), <b>[b][/b]</b>, və s.. Forma təqlərində olduğu kimi, bütün digər funksional təqlərin düzgün bir şəkildə, sıra ilə bağlanmasına nəzarət etməlisiniz. məs.:<br /><br /><b>[url=http://www.phpbb.com/][img]</b>http://www.phpbb.com/images/phplogo.gif<b>[/url][/img]</b><br /><br />doğru <u>deyil</u> və hətta ismarışınızın silinməsinə səbəb ola bilər, burda diqqətli olmalısınız.");
