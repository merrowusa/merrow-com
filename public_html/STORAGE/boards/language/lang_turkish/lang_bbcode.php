...
$faq[] = array("--", "Baðlantý (kýsayol) Yaratma");
$faq[] = array("Ayrý bir siteye baðlantý verme", "BBCode baðlantý (URL) oluþturmak için deðiþik yöntemleri destekler.<ul><li>Birinci yöntem <b>[url=][/url]</b> tag'iyledir. = iþaretinin arkasýna yazýlanlar baðlantý olarak çalýþýr. Örneðin phpBB.com'a baðlantý vermek için þu þekilde yazýn:<br /><br /><b>[url=http://www.phpbb.com/]</b>phpBB'yi ziyaret edin!<b>[/url]</b><br /><br />Sonuçta þu baðlantýyý göreceksiniz: <a href=\"http://www.phpbb.com/\" target=\"_blank\">phpBB'yi ziyaret edin!</a> Bu baðlantýyý týklayýnca ayrý bir pencere açýlýr. Böylece kullanýcý forum'u gezmeye devam edebilir.</li><li>Baðlantý adresinin gösterilmesini istiyorsanýz, þu þekildede yazabilirsiniz:<br /><br /><b>[url]</b>http://www.phpbb.com/<b>[/url]</b><br /><br />Sonuçta þu baðlantýyý göreceksiniz: <a href=\"http://www.phpbb.com/\" target=\"_blank\">http://www.phpbb.com/</a></li><li>phpBB ayrýca <i>Sihirli Baðlantýlar</i> denen bir iþleme sahip. Bunun sayesinde, kurallara uygun bir þekilde yazýlan her baðlantý adresi otomatik olarak baðlantýya çevrilir, herhangi bir tag, hatta http:// yazmanýza gerek kalmaz. Örn. www.phpbb.com yazýnca, izlenim sayfasýnda otomatik olarak <a href=\"http://www.phpbb.com/\" target=\"_blank\">www.phpbb.com</a> olarak görüntülenir.</li><li>Ayný iþlem email adresleri için uygulanýr. Dilerseniz özel olarak bir adres belirleyebilirsiniz, örn.:<br /><br /><b>[email]</b>no.one@domain.adr<b>[/email]</b><br /><br />yazýlýnca þu þekilde görüntülenir: <a href=\"emailto:no.one@domain.adr\">no.one@domain.adr</a> Veya basitçe no.one@domain.adr yazabilirsiniz ve mesajýnýz görüntülendiðinde bu kýsým otomatik olarak baðlantýya çevrilir.</li></ul>Bütün BBCode tag'leri gibi, baðlantý adreslerinide diðer tag'lerin içine alabilirsiniz, örn. <b>[img][/img]</b> (bir sonraki madde bakýn), <b>[b][/b]</b>, vs. Biçimleme tag'lerinde olduðu gibi, tag'lerin düzgün bir þekilde sýrasýyla kapatýlmasýný kendiniz saðlamalýsýnýz, örn.:<br /><br /><b>[url=http://www.phpbb.com/][img]</b>http://www.phpbb.com/images/phplogo.gif<b>[/url][/img]</b><br /><br />doðru <u>deðildir</u> ve hatta mesajýnýzýn silinmesine yol açabilir, bu konuda dikkatli olmanýz gerek.");
