...
//
$lang['Admin'] = 'Yönetim';
$lang['Not_admin'] = 'Bu mesaj panosunun yöneticiliðini yapma yetkiniz yok';
$lang['Welcome_phpBB'] = 'phpBB\'ye hoþgeldiniz';
$lang['Admin_intro'] = 'PhpBB\'yi forumunuz olarak seçtiðiniz için teþekkür ederiz. Bu ekran size mesaj panonuzun bilgilerinin kýsa bir özetini sunmaktadýr. Bu sayfaya sol paneldeki <u>Yönetim Ana Sayfa</u> baðlantýsýna týklayarak geri dönebilirsiniz. Mesaj panonuzun ana sayfasýna dönmek için soldaki küçük logoyu kullanabilirsiniz. Soldaki diðer baðlantýlar forumunuzun her türlü ayarýný yapmanýzý saðlayacaktýr, her ekran kendinin nasýl kullanýlacaðýný anlatacaktýr.';
...
$lang['Structure_backup'] = 'Sadece tablo yapýsýný yedekle';
...
$lang['Restore_success'] = 'Veritabaný baþarýyla yedeklendi.<br /><br />Mesaj panonuz yedeklemenin yapýldýðý zamanki haline dönüþtürüldü.';
$lang['Backup_download'] = 'Ýndirme kýsa bir süre içinde baþlayacak, lütfen bekleyin';
...
$lang['Look_up_User'] = 'Kullanýcýyý Ýncele';
$lang['Look_up_Group'] = 'Grubu Ýncele';
$lang['Look_up_Forum'] = 'Forumu Ýncele';
...
$lang['Pollcreate'] = 'Anket oluþturma';

$lang['Permissions'] = 'Ýzinler';
$lang['Simple_Permission'] = 'Basit Ýzinler';
...
$lang['Ban_username_explain'] = 'Birden fazla kullanýcý yasaklamak istiyorsanýz tarayýcýnýza uygun klavye - fare kombinasyonunu kullanýn';
...
$lang['Unban_username_explain'] = 'Birden fazla kullanýcýnýn yasaðýný kaldýrmak istiyorsanýz tarayýcýnýza uygun klavye - fare kombinasyonunu kullanýn';

$lang['Unban_IP'] = 'IP/Host yasaðý kaldýrma';
$lang['Unban_IP_explain'] = 'Birden fazla IP/Host yasaðý kaldýrmak istiyorsanýz tarayýcýnýza uygun klavye - fare kombinasyonunu kullanýn';

$lang['Unban_email'] = 'E-posta yasaðý kaldýrma';
$lang['Unban_email_explain'] = 'Birden fazla e-posta yasaðý kaldýrmak istiyorsanýz tarayýcýnýza uygun klavye - fare kombinasyonunu kullanýn';
...
$lang['Config_explain'] = 'Aþaðýdaki form tüm genel mesaj panosu ayarlarýný yapmak için kullanýlacaktýr. Kullanýcý ve forum bazlý ayarlar için sol taraftaki ilgili baðlantýlara týklayýnýz.';

$lang['Click_return_config'] = 'Genel ayarlara dönmek için %sburaya%s týklayýn';

$lang['General_settings'] = 'Genel Mesaj Panosu Ayarlarý';
$lang['Server_name'] = 'Alan Adý';
$lang['Server_name_explain'] = 'Bu mesaj panosunun bulunduðu alan adý adresi';
...
$lang['Board_disable_explain'] = 'Bu, mesaj panosunu kullanýcýlara kapatacaktýr. Yöneticiler mesaj panosu kapalý olduðu zaman Yönetim Paneline giriþ yapabilirler.';
...
$lang['Max_poll_options'] = 'En yüksek anket seçeneði sayýsý';
$lang['Flood_Interval'] = 'Flood Aralýðý';
$lang['Flood_Interval_explain'] = 'Kullanýcýnýn iki mesajý arasýnda beklemesi gereken süre';
$lang['Board_email_form'] = 'Mesaj panosu üzerinden kullanýcý e-postasý';
$lang['Board_email_form_explain'] = 'Bu, mesaj panosu aracýlýðý ile kullanýcýlarýn birbirlerine e-posta göndermesini saðlar';
$lang['Topics_per_page'] = 'Her sayfadaki baþlýk sayýsý';
$lang['Posts_per_page'] = 'Her sayfadaki mesaj sayýsý';
$lang['Hot_threshold'] = 'Popülerlik Baþlangýcý için mesaj sayýsý';
...
$lang['Max_sig_length'] = 'En fazla imza uzunluðu';
$lang['Max_sig_length_explain'] = 'Kullanýcý imzalarýndaki en fazla karakter sayýsý';
...
$lang['Allow_remote_explain'] = 'Baþka bir siteden baðlantý verilen avatarlar';
$lang['Allow_upload'] = 'Avatar göndermeyi aç';
$lang['Max_filesize'] = 'En yüksek Avatar dosya büyüklüðü';
$lang['Max_filesize_explain'] = 'Gönderilen avatarlar için';
$lang['Max_avatar_size'] = 'En yüksek avatar boyutlarý';
$lang['Max_avatar_size_explain'] = '(Piksel cinsinden Yükseklik x Geniþlik)';
...
$lang['COPPA_mail_explain'] = 'Ebeveynlerin COPPA anlaþmasýný gönderecekleri e-posta adresi';

$lang['Email_settings'] = 'E-posta Ayarlarý';
$lang['Admin_email'] = 'Yönetici E-posta Adresi';
$lang['Email_sig'] = 'E-posta Ýmzasý';
$lang['Email_sig_explain'] = 'Mesaj panosunun göndereceði tüm e-postalara bu yazý eklenir';
...
$lang['Inbox_limits'] = 'Gelen kutusundaki en yüksek mesaj sayýsý ';
$lang['Sentbox_limits'] = 'Ulaþan kutusundaki en yüksek mesaj sayýsý';
$lang['Savebox_limits'] = 'Kaydedilen kutusundaki en yüksek mesaj sayýsý';
...
$lang['Autologin_time_explain'] = 'Kullanýcýlarýn beni hatýrla seçeneðini seçerek otomatik giriþlerinin geçerliliði için gün süresi.Özelliði iptal etmek için 0 (sýfýr) yazýn.';
...
$lang['Create_forum'] = 'Yeni forum oluþtur';
$lang['Create_category'] = 'Yeni kategori oluþtur';
$lang['Remove'] = 'Çýkar';
$lang['Action'] = 'Eylem';
...
$lang['Forum_edit_delete_explain'] = 'Aþaðýdaki form genel mesaj panosu ayarlarýný yapmak için kullanýlacaktýr. Kullanýcý ve forum bazlý ayarlar için sol taraftaki ilgili baðlantýlara týklayýnýz.';
...
$lang['Set_prune_data'] = 'Otomatik budamayý açtýðýnýz halde kaç günde bir mesaj temizliði yapýlacaðýný seçmediniz.Lütfen geri dönün ve seçin.';
...
$lang['Edit_Category_explain'] = 'Bir kategorinin ismini düzenlemek için bu formu kullanýn.';
...
// Smiley Management
//
$lang['smiley_title'] = 'Ýfade Düzenleme Paneli';
...
$lang['User_admin_explain'] = 'Buradan kullanýcýlarýnýzýn ayarlarýný deðiþtirebilirsiniz. Ýzinleri deðiþtirmek için soldan Ýzinler baðlantýsýný kullanýn.';
...
//
$lang['Forum_Prune'] = 'Forum Budamasý';
$lang['Forum_Prune_explain'] = 'Bu form ile seçtiðiniz gün sayýsý içinde cevap gelmeyen baþlýklarý silebilirsiniz. Eðer bir sayý girmezseniz tüm mesajlar silinir. Ýçinde anket olan mesajlar ya da duyurular silinmeyecektir. Onlarý tek tek elle silmek zorundasýnýz.';
$lang['Do_Prune'] = 'Buda';
$lang['All_Forums'] = 'Tüm forumlar';
$lang['Prune_topics_not_posted'] = 'Bu kadar gün içinde cevap gelmemiþ baþlýklarý buda';
$lang['Topics_pruned'] = 'Budanan baþlýklar';
$lang['Posts_pruned'] = 'Budanan mesajlar';
$lang['Prune_success'] = 'Forumlarýn budanmasý baþarýlý';
...
$lang['Rank_minimum'] = 'En Düþük Mesaj Sayýsý';
$lang['Rank_maximum'] = 'En Yüksek Mesaj Sayýsý';
...
$lang['Link_color'] = 'Baðlantý Rengi';
$lang['Text_color'] = 'Yazý Rengi';
$lang['VLink_color'] = 'Ziyaret Edilmiþ Baðlantý Rengi';
$lang['ALink_color'] = 'Aktif Baðlantý Rengi';
$lang['HLink_color'] = 'Üstüne Gelinen Baðlantý Rengi';
...
$lang['continue_upgrade'] = 'Config dosyasýný bilgisayarýnza indirdikten sonra \'Güncelleme\'ye Devam\' düðmesine basarak güncelleme iþlemine devam edebilirsiniz.';
...
$lang['Unwriteable_config'] = 'Þu anda config dosyasýna yazýlamýyor. Aþaðýdaki düðmeye nasýnca bu config dosyasýnýn bir kopyasý bilgisayarýnýza indirilecektir. Bu dosyayý phpBB2 ile ayný klasör içine göndermelisiniz. Bunu yaptýktan sonra bir önceki form\'la yaratýlan yönetici adý ve þifresini kullanarak yönetim paneline girmeli ve ayarlarý yapmalýsýnýz. (Mesaj panosuna giriþ yaptýktan sonra ekranýn altýnda bir baðlantý gözükecektir). PhpBB2\'yi seçtiðiniz için teþekkür ederiz.';
...
$lang['Max_login_attempts_explain'] = 'Mesaj panosunda kullanýcýlara izin verilen en yüksek giriþ deneme sayýsý'; 
$lang['Login_reset_time'] = 'Giriþ kilitleme süresi'; 
$lang['Login_reset_time_explain'] = 'Ýzin verilen en yüksek giriþ deneme sayýsý geçildiði zaman kullanýcý hesabýnýn kilitli kalacaðý süre';
