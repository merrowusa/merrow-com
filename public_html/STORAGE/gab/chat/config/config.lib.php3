...
?>
<?php
define("C_DB_NAME", 'merrowco_pchat1');                                 // Logical database name on
define("C_DB_USER", 'merrowco_pchat1');                                // Database user
define("C_DB_PASS", 'dF2VHE1Qac');                                // Database userxs password
define("C_DB_HOST", 'localhost');                               // Hostname of your MySQL server
?>
