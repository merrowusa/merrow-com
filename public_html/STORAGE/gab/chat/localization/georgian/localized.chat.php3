<?php
// File : georgian.lang.php3
// Translation by George Gongadze <webmaster@georgia-gateway.org>

// extra header for charset
$Charset = "x-user-defined";
// There is no real official iso code for georgian charset. The var bellow define the
// name of the font and of a zip file containing it. An english message suggesting
// the user to download the file will be displayed at the top of the start page.
$FontName = "Geo_Times";
...
define("L_WEL_1", "шдтзоаимдадаи шдимюАдаю");
define("L_WEL_2", "сююхи, Аоко лолАлюрдадкхю сюАдкдаи");
define("L_WEL_3", "ъжхи ...");

define("L_CUR_1", "юАкю систдлюшию");
define("L_CUR_2", "");
define("L_CUR_3", "лолАлюрдадки охюАдаши");
define("L_CUR_4", "лолАлюрдадки йдрчо охюАдаши");

define("L_SET_1", "бхАоех лижхихох ...");
define("L_SET_2", "хьедми сюАдки");
define("L_SET_3", "шдтзоаимдадаис рюоцдмоаю");
define("L_SET_4", "бюмюАкдаис цро");
define("L_SET_5", "юлоирэидх охюАи ...");
define("L_SET_6", "чирихюци охюАи");
define("L_SET_7", "Make your choice ...");
define("L_SET_8", "лолАлюрдадкхю лидр шдьлмики охюАдаи");
define("L_SET_9", "шдьлдмих хьедми");
define("L_SET_10", "public");
define("L_SET_11", "private");
define("L_SET_12", "охюАи");
define("L_SET_13", "юАкю йи");
define("L_SET_14", "е и Ю о р ю о х");

define("L_SRC", "зедкюсхеис");
...
define("L_REG_17", "Your informations were successfully updated.");
define("L_REG_18", "You have been kicked away from the room by a moderator.");
...
define("L_EXIT", "бюлосекю");
define("L_DETACH", "бюхишею");
define("L_EXPCOL_ALL", "Expand/Collapse All");
define("L_CONN_STATE", "Connection state");
define("L_CHAT", "эюти");
define("L_USER", "лолАлюрдадки");
define("L_USERS", "лолАлюрдадки");
define("L_NO_USER", "лолАлюрдадки юр юрис");
define("L_ROOM", "охюАи");
define("L_ROOMS", "охюАдаи");
...
// input frame
define("L_HLP", "Help");
define("L_BAD_CMD", "юрюрсдажки арчюмдаю !");
...
define("L_HELP_TIT_3", "арчюмдадаи");
define("L_HELP_USR", "лолАлюрдадки");
define("L_HELP_MSG", "message");
define("L_HELP_ROOM", "охюАи");
define("L_HELP_CMD_0", "{} южщикдадки пюрюлдтрдаисхеис, [] юрююжщикдадки пюрюлдтрдаисхеис.");
define("L_HELP_CMD_1", "цююздмдх юрюмюйкда 5 шдтзоаимдадаис эедмдаю.");
...
define("L_HELP_CMD_2a", "дйрюмис бюмюАкдаис цро (ъюлдаши).<BR>хж n юр юрис лихихдажки - юрюмюйкда 3-сю.");
...
define("L_HELP_CMD_3", "шдтзоаимдадаис сортирдаю.");
define("L_HELP_CMD_4", "сАею охюАши бюцюсекю, хьедми сюйжхюри охюАис шдьлмю.");
...
define("L_HELP_CMD_5", "эютицюм бюлосекю [msg] шдтзоаимдаих.");
define("L_HELP_CMD_6", "лолАлюрдакис (nick) шдтзоаимдадаис ибморирдаю, хж nick юр юрис лихихдажки.<BR>лолАлюрдакис шдтзоаимдадаис эедмдаю хж nick цю - пюрюлдтрдаи лихихдажкию.<BR>хж лихихдажкию люрто - пюрюлдтри, дйрюмфд бюлоэмцдлю зедкю шдтзоаимдаю.<BR>пюрюлдтрдаис бюрдшд дс арчюмдаю юэедмдас вюмЦюрюс зедкю nick-их, ролдкхю шдтзоаимдадаищ юр бюлоэмцдаю.");
...
define("L_HELP_CMD_7", "ъимю стриьомис бюлочюАдаю.");
define("L_HELP_CMD_8", "шдтзоаимдаис ъим цроис цюлюкею юм бюлоэдмю.");
...
// messages frame
define("L_NO_MSG", "шдтзоаимдадаи юр юрис ...");
...
// ignored popup
define("L_IGNOR_TIT", "ибморирдажкию");
define("L_IGNOR_NON", "ибморирдажки лолАлюрдакдаи юр юриюм");
