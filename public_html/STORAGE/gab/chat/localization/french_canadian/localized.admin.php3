...
define("A_SHEET2_6", "Les salons sont séparés par une virgule sans espace (,) s'ils sont moins de 4, au-delà le sigle<BR>'<B>&nbsp;*&nbsp;</B>' bannit de tout salon.");
