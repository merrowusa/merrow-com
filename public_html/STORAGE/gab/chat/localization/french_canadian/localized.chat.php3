<?php
// File : french_canadian.lang.php3
...
define("L_WEL_1", "Messages et pseudonymes sont respectivement effacés au bout de");
...
define("L_SET_2", "votre pseudonyme");
...
define("L_REG_31", "nom");
define("L_REG_32", "page perso");
define("L_REG_33", "courriel visible via la commande /whois");
define("L_REG_34", "Édition de votre profil");
...
// error messages
define("L_ERR_USR_1", "Un utilisateur dispose déjà de ce pseudonyme. Veuillez en choisir un autre.");
define("L_ERR_USR_2", "Vous n'avez pas choisi votre pseudonyme or il en faut un !");
define("L_ERR_USR_3", "Ce pseudonyme est celui d'un utilisateur enregistré.<BR>Entrez le mot de passe associé ou choisissez un autre pseudonyme.");
define("L_ERR_USR_4", "Mot de passe invalide.");
define("L_ERR_USR_5", "Vous devez choisir un pseudonyme.");
define("L_ERR_USR_6", "Vous devez choisir un mot de passe.");
define("L_ERR_USR_7", "Vous devez entrer votre adresse courriel.");
define("L_ERR_USR_8", "Courriel invalide.");
define("L_ERR_USR_9", "Ce pseudonyme est déjà reservé.");
define("L_ERR_USR_10", "Pseudonyme et/ou mot de passe invalide(s).");
...
define("L_ERR_USR_16", "Un pseudonyme ne peut contenir ni espace, ni virgule, ni anti-slash (\\).");
define("L_ERR_USR_17", "Ce salon n'existe pas et vous n'êtes pas autorisé à en créer un.");
define("L_ERR_USR_18", "Mot interdit dans votre pseudonyme.");
