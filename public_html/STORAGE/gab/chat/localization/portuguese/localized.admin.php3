...
// Translation by Gustavo Felisberto <humpback@d-attitude.com>
...
define("A_SHEET1_2", "Nome de utilizador");
define("A_SHEET1_3", "Permissões");
define("A_SHEET1_4", "Salas moderadas");
define("A_SHEET1_5", "Salas moderadas são separadas por virgula (,) sem espaços entre elas.");
define("A_SHEET1_6", "Remover os perfis seleccionados");
define("A_SHEET1_7", "Mudar");
...
define("A_SHEET3_2", "Limpar uma sala \"non-default\" vai tambem limpar todas as definições de moderação dessa sala.");
define("A_SHEET3_3", "Limpar salas seleccionadas.");
