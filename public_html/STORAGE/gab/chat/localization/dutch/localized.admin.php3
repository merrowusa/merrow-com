...
define("A_SHEET1_3", "Permissies");
define("A_SHEET1_4", "Gemodereerde rooms");
define("A_SHEET1_5", "Gemodereerde rooms worden geschijden door komma's (,) zonder spaties.");
