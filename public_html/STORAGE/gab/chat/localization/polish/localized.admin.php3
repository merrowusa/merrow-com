...
define("A_SHEET1_2", "Nick");
define("A_SHEET1_3", "Uprawnienia");
define("A_SHEET1_4", "Kana³y zarz±dzane");
define("A_SHEET1_5", "Zarz±dzane kana³y s± oddzielone przecinkami (,) bez spacji.");
define("A_SHEET1_6", "Usuniêcie sprawdzone");
define("A_SHEET1_7", "Zmieñ");
...
define("A_USER", "U¿ytkownik");
define("A_MODER", "Zarz±dca");
