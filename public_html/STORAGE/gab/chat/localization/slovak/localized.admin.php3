...
// Translation by Marek Rybar <webmaster@satelit.sk>
...
define("A_SHEET1_2", "Užívate¾ské meno");
define("A_SHEET1_3", "Permissions");
define("A_SHEET1_4", "Moderované miestnosti");
define("A_SHEET1_5", "Moderované miestnosti sú oddelené èiarkou (,) bez medzier.");
define("A_SHEET1_6", "Odstráò oznaèené profily");
define("A_SHEET1_7", "Zmeò");
