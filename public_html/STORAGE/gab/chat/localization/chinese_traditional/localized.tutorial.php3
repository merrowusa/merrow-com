...
<A HREF="#modProfile" CLASS="topLink">修改<?php if (C_SHOW_DEL_PROF == "1") echo("/刪除"); ?>個人資料</A><BR>
<?php
if (C_VERSION == "2") 
{
	?>
...
&nbsp&nbsp&nbsp&nbsp<A HREF="#help" CLASS="topLink">求助指令</A><BR>
<?php
if (C_USE_SMILIES == "1")
{
	?>
...
&nbsp&nbsp&nbsp&nbsp<A HREF="#whois" CLASS="topLink">取得其他聊天者的資料</A><BR>
<?php
if (C_SAVE != "0")
{
	?>
...
&nbsp&nbsp&nbsp&nbsp<A HREF="#kick" CLASS="topLink">把使用者踢出聊天室</A><BR>
<?php
if (C_BANISH != "0")
{
	?>
...
<P>
已經註冊的使用者請鍵入您的使用名稱及密碼,<BR>再選擇欲進入的聊天室,最後按[聊天]開始聊天.<BR>
<?php
...
<P>
<A NAME="modProfile"></A>當然,已註冊者可自行修改
<?php if (C_SHOW_DEL_PROF == "1") echo("/刪除"); ?> 個人的資料於登入聊天室時的修改選項<?php echo((C_SHOW_DEL_PROF == "0" ? "連結" : "連結")); ?>中..<BR>
<BR><P ALIGN="right"><A HREF="#top">回頁首</A></P>
<P>
<HR>
...
輸入完畢後按[Enter]開始傳送聊天訊息到所有聊天者的視窗中.
<?php if (C_NO_SWEAR == "1") echo("請注意\"不雅字語\"將被忽略於訊息中."); ?>
<P>
