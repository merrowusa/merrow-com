...
$installed=TRUE;
if($installed!=TRUE){
 die("<div align=center><b>Alert:</b> You need to <i><a href='".$GLOBALS['conf']['url']."/modules/osTicket/setup.php'>install osTicket</a></i> or deactivate it by editing its hcl config file.</div><p/>");
}
...
$homepath_dir="http://merrow.com/help/modules/osTicket/";
/*The Title */
$osticket_title="Merrow Sewing Machine Co.";
/*The root path to osticket install directory */
$rootpath_dir="/home/merrowco/public_html/help/modules/osTicket/";
...
define('HOME_DIR',$homepath_dir);
define('OSTICKET_TITLE',$osticket_title);
define('ROOT_DIR',$rootpath_dir);
define('INCLUDE_DIR',$include_dir);

/*Configure your MySQL Settings */
$db_type = "mysql_options.php";
$db_host = "localhost";
$db_name = "merrowco_hclv1";
$db_user = "merrowco_hclv1";
$db_pass = "UfcBuE8s73ix";
