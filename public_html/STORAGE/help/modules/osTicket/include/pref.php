  ...
  <form action="<?php echo($GLOBALS['conf']['modules']['osTicket']['url']); ?>admin.php" method="post">
    ...
    if ($_SESSION[user][type] == "admin") {
        ...
        <table width="100%" border="0" cellspacing=0 cellpadding=0>
          ...
          <tr>
            <td><img src="<?php echo($GLOBALS['conf']['modules']['osTicket']['realurl']); ?>images/spacer.gif" width="1" height="10"></td>
          </tr>
        </table>
        <?
    }
    ?>
        ...
        <table cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td><img src="<?php echo($GLOBALS['conf']['modules']['osTicket']['realurl']); ?>images/spacer.gif" width="1" height="5"></td>
          </tr>
        </table>
        <table width="100%" border="0" cellspacing=1 cellpadding=2 class="TableMsg">
          <tr>
