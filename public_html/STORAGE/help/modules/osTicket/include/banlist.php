...
if(!defined('OST_INC'))
    die("Invalid path");
?>
<form action="<?php echo($GLOBALS['conf']['modules']['osTicket']['url']); ?>admin.php">
...
<table border="0" cellspacing="0" cellpadding="4">
	<tr>
		...
		&nbsp;&nbsp;<a href="<?php echo($GLOBALS['conf']['modules']['osTicket']['url']); ?>admin.php&a=banlist&cmd=reset">Show all</a>
		</td>
	</tr>
...
<form method="post">
  <table width="100%" border="0" cellspacing="1" cellpadding="2" class="TableMsg">
    <tr> 
      <td class="TableHeaderText" colspan="4">&nbsp;Ban List<a href="<?php echo($GLOBALS['conf']['modules']['osTicket']['url']); ?>admin.php&a=banlist&order=<?php echo urlencode("value"); ?>">&nbsp;
...
?>
    <tr class="mainTableAlt"> 
      ...
      <td width="30" align="center"><a href="<?php echo (!is_null(@$row["value_id"])) ? $GLOBALS['conf']['modules']['osTicket']['url']."admin.php&a=banlist_edit&key=".urlencode($row["value_id"]) : "javascript:alert('Invalid Record! Key is null');";	?>
">Edit</a></td>
      <td width="41" align="center"><a href="<?php echo (!is_null(@$row["value_id"])) ? $GLOBALS['conf']['modules']['osTicket']['url']."admin.php&a=banlist_add&key=".urlencode($row["value_id"]) : "javascript:alert('Invalid Record! Key is null');";	?>
">Copy</a></td>
      <td>
        &nbsp;<?php echo $x_value; ?>
        &nbsp;</td>
...
?>	
	<a href="<?php echo($GLOBALS['conf']['modules']['osTicket']['url']); ?>admin.php&a=banlist&start=<?php echo $PrevStart; ?>"><b>Prev</b></a>
<?php
	}
...
?>
	<a href="<?php echo($GLOBALS['conf']['modules']['osTicket']['url']); ?>admin.php&a=banlist&start=<?php echo $x; ?>"><b><?php echo $y; ?></b></A>
<?php	
				}
				$x = $x + $displayRecs;
				$y = $y + 1;
...
?>
	<a href="<?php echo($GLOBALS['conf']['modules']['osTicket']['url']); ?>admin.php&a=banlist&start=<?php echo $x;?>"><b><?php echo $y; ?>-<?php echo $y+$recRange-1; ?></b></a>
<?php 
				} else {
...
?>
	<a href="<?php echo($GLOBALS['conf']['modules']['osTicket']['url']); ?>admin.php&a=banlist&start=<?php echo $x; ?>"><b><?php echo $y; ?>-<?php echo $ny; ?></b></a>
<?php	
					}
				}
  ...
  if ($totalRecs >= $startRec + $displayRecs) {
		...
		$isMore = True
?>
	<a href="<?php echo($GLOBALS['conf']['modules']['osTicket']['url']); ?>admin.php&a=banlist&start=<?php echo $NextStart; ?>"><b>Next</b></a>
<?php 
	} else {
		$isMore = False;
	}	
...
<td><img src="<?php echo($GLOBALS['conf']['modules']['osTicket']['realurl']); ?>images/spacer.gif" width="10" height="1"></td>
</td><td valign="top">

<form onSubmit="return EW_checkMyForm(this);"  action="<?php echo($GLOBALS['conf']['modules']['osTicket']['url']); ?>admin.php" method="post">
<p>
