  ...
  <tr> 
    <td> 
      <table cellspacing="0" cellpadding="0" border="0">
        <tr>
          <td><img src="<?php echo($GLOBALS['conf']['modules']['osTicket']['realurl']); ?>images/spacer.gif" width="1" height="3"></td>
        </tr>
      </table>
      <table>
        <tr>
...
<tr> 
  <td align="center">
    ...
    <table cellspacing="1" cellpadding="5" border="0" bgcolor="#000000">
      <form action="<?php echo($GLOBALS['conf']['modules']['osTicket']['url']); ?>view.php" method="post">
