...
<table width="100%" border="0" cellspacing=0 cellpadding=0><tr><td>
	<table width="100%" border="0" cellspacing=0 cellpadding=0><tr class="TableMsg">
		<td width="1"><img src="<?php echo($GLOBALS['conf']['modules']['osTicket']['realurl']); ?>images/spacer.gif" width="1" height="1"></td>
		<td><table border="0" cellspacing=3 cellpadding=0><tr>
			<td class="TableHeaderText">&nbsp;New Ticket Reply</td></tr></table></td>
		<td width="1"><img src="<?php echo($GLOBALS['conf']['modules']['osTicket']['realurl']); ?>images/spacer.gif" width="1" height="1"></td>
	</tr><tr>
		<td class="TableHeader"><img src="<?php echo($GLOBALS['conf']['modules']['osTicket']['realurl']); ?>images/spacer.gif" width="1" height="1"></td>
