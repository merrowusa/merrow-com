...
<img src="<?php echo($GLOBALS['conf']['modules']['osTicket']['realurl']); ?>images/spacer.gif" width="1" height="10"><br>
...
<a href="<?php echo($GLOBALS['conf']['modules']['osTicket']['url']); ?>admin.php&a=banlist">Back to List</font></a>
