...
<div id="footer">
  {$lang.powered_by} <a href="http://www.helpcenterlive.com" target="_blank">Help Center Live</a> {$conf.version}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Copyright &copy; <a href="http://www.ubertec.co.uk">UberTec Ltd</a>. All Rights Reserved.</a>
</div>
</body>
</html>