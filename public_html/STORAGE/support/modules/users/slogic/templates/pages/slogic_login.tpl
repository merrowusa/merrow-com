		<form name="login_form" method="post" action="{SCRIPT_URL}index.php">
		<table border="0" align="center" cellpadding="4" cellspacing="0" class="boxtable" width="400">
			...
			<tr>
				<td height="17" colspan="2" align="center"><a href="{SCRIPT_URL}index.php?register=1">[Click here to register a helpdesk account.]</a></td>
			</tr>
		</table>
		</form>
