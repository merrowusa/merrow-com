...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="usertable">
  <tr> 
    <td height="20" colspan="3" class="head">&nbsp;{LANG_TICKETS_ASSIGNED_TICKETS}</td>
    <td height="20" colspan="3" class="head" align="right">Show next 20 tickets starting at ticket: <input type="text" class="input"  name="limit" size="4"><input type="hidden" name="tpl" value="tickets_list_open_assigned"><input type="hidden" name="lang" value="{LANG}"><input type="hidden" name="order_table" value="open_assigned"> <input type="Submit" name="submit" value="Go!" class="button"></td>
  </tr>
  <tr> 
  ...
  <tr class="title"> 
    ...
    <td height="17" width="10%"><b>{LANG_TICKETS_STAFF}</b>&nbsp;&nbsp;&nbsp;{ORDER_STAFF}{LANG_TICKETS_ARROW_DOWN}</a>&nbsp;{ORDER_STAFF_DESC}{LANG_TICKETS_ARROW_UP}</a></td>
