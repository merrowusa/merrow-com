...
{
	$output = join ('', file (SCRIPT_PATH.'modules/staff/slogic/templates/functions/slogic_list_announcements.tpl'));
	...
	{
		// get announcements
		$this->query_result = $db->db_query('SELECT id,subject,sent_date,show_date FROM announcements WHERE show_to!=\'users\' AND (show_date!=\'never\') ORDER BY sent_date DESC');
