...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="stafftable">
  <tr> 
    <td height="20" colspan="3" class="head">&nbsp;{LANG_TICKETS_STAFF_UPDATED_TICKETS}</td>
    <td height="20" colspan="3" class="head" align="right">Show next 20 tickets starting at ticket: <input type="text" class="input"  name="limit" size="4"><input type="hidden" name="tpl" value="tickets_list_staff_updated"><input type="hidden" name="lang" value="{LANG}"><input type="hidden" name="order_table" value="staff_updated"> <input type="submit" class="button" name="Submit" value="Go!"></td>
  </tr>
  <tr> 
  ...
  <tr class="title"> 
    ...
    <td height="17" width="10%"><b>{LANG_TICKETS_LAST_UPDATE}</b>&nbsp;{ORDER_LAST_UPDATE}{LANG_TICKETS_ARROW_DOWN}</a>&nbsp;{ORDER_LAST_UPDATE_DESC}{LANG_TICKETS_ARROW_UP}</a></td>
  </tr>
<TICKETS>
  <tr class="subhead"> 
