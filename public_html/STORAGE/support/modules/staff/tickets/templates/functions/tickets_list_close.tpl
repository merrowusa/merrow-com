...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="stafftable">
  <tr> 
    <td height="20" colspan="3" class="head">&nbsp;{LANG_TICKETS_CLOSE_TICKETS}</td>
    <td height="20" colspan="3" class="head" align="right">Show next 20 tickets starting at ticket: <input type="text" class="input"  name="limit" size="4"><input type="hidden" name="tpl" value="tickets_list_close"><input type="hidden" name="lang" value="{LANG}"><input type="hidden" name="order_table" value="close"> <input type="submit" class="button" name="Submit" value="Go!"></td>
  </tr>
  <tr> 
