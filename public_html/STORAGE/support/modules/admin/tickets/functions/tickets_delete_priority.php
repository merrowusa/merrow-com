...
// delete priority(s) as provided by $_POST['del'] array
function tickets_delete_priority()
{
	GLOBAL $user_screen;
	...
	if ($db->db_connected)
	{
		$this->query_result = $db->db_query('DELETE FROM priorities WHERE id="'.$make_query.'"');
	}
	$db->db_close();
	...
	$user_screen = str_replace('{MESSAGE}','{LANG_TICKETS_LIST_PRIORITIES_DELETED}',$user_screen);
