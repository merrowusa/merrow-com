 ...
 */
 ...
 .props({
	...
	window.encodeURI  = function(str){
		...
		var utf8 = vjo.darwin.core.encoding.Enc.isUTF8();
		if(utf8){
			return vjoEncodeURI(str); // might be safest may be problems with partial uris.
		}
		return vjoEscape(str);
	};
...
if(!lh.has("motors.shop.")&&lh.hasAny("shop.","local.","catalog.")&&B.bIE){
iL+=15;
iT-=2;
}else{
...
return cf.cobrandURL(_2b);
}
return _2b;
},add:function(_2d,_2e,_2f){
...
},replaceJSONDataHandler:function(_31,_32){
if(_31!=null){
this.sHandler=_31;
}
if(_32!=null){
...
var _d = vjo.dsf.EventDispatcher;
var _r = vjo.Registry;
_d.add('body','load',function(event) { vjo.Registry._category0.fill(); });})();})();
...
vjo.needs("vjo.dsf.typeextensions.string.TokenReplacement");
vjo.needs("vjo.dsf.document.Element");
vjo.type("vjo.darwin.core.ebayheader.rebate.Rebate").props({Refresh:function(_1,_2){
var D=vjo.dsf.document,E=D.Element,C=vjo.dsf.cookie.VjCookieJar;
var _4=E.get(_1),image=_4.getElementsByTagName("img")[0],rate=C.readCookie("npii","mri");
if(!rate){
return;
}
var _5=this.GetRate(rate);
if(_5){
_5=this.IsValidRate(_5);
}
if(this.IsExpired()){
return;
}
if(_4&&_5!==null&&image){
image.src=image.src.replaceToken(image.src,_2,_5);
E.toggleHideShow(_1,true);
}
},IsExpired:function(){
var _6=new Date().getTime();
var _7=this.getClientOffset(_6);
var _8=vjo.dsf.cookie.VjCookieJar.readCookieObj("npii","mri");
if(_8!==null){
var _9=parseInt(_8.maxage,16)*1000;
if(_9>0){
var _a=_9-_6+_7;
if(_a<0){
return true;
...
return false;
},getClientOffset:function(_b){
var _c;
var _d=vjo.dsf.cookie.VjCookieJar.readCookie("ebay","cos");
if(_d!==null&&_d.length>0){
_c=parseInt(_d,16)*1000;
}else{
_c=1800000;
}
return _c;
},IsValidRate:function(_e){
var R=parseInt(_e,10);
...
(function () {
var _r = vjo.Registry;
function _c0 (psAnchorId,psContainerLayerId,piLeftPadding,psJSONDataHandler) { return new vjo.darwin.core.dynamicmenu.DynamicMenu(psAnchorId,psContainerLayerId,"dynMenuCtr",75,250,900,800,1,1,1,piLeftPadding,1,0,psJSONDataHandler,"items","","hovered","","",""); }
_r.put('BuyMenu', _c0("Buy","Buy-menu",5,"get_Buy_menu")); _r.put('SellMenu', _c0("Sell","Sell-menu",1,"get_Sell_menu")); _r.put('MyEbayMenu', _c0("MyEbay","MyEbay-menu",1,"get_MyEbay_menu")); _r.put('CommunityMenu', _c0("Community","Community-menu",1,"get_Community_menu")); _r.put('HelpMenu', _c0("Help","Help-menu",1,"get_Help_menu")); })();
/* end comp spec*/
...
// en_US/e565/GlobalNavVjo23_Ebay_e5656617860_1_en_US
// b=6617860