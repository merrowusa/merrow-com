...
if(empty($_SESSION['exp_user']) || @$_SESSION['exp_user']['expires'] < time()) {
	header("location:fp_secure_agent_login.php?party_id=".$_GET['party_id']."&choice=".$_GET['choice']."&store=65533122844756220294");	//@ redirect 
} else {
...
<div class="exit_button"> <input name="Big Button" value="Exit Store Configuration" type="button" onclick="location.href='http://merrow.com/cephei/sable/fp_dynamicstore.php?party_id=<? echo $party_id; ?>&choice=<? echo $choice; ?>&store=65533122844756220294'">  click on the images to change them, and on the pencil icons to edit the text    
</div>
