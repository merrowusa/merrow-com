...
?>
 ...
 <!-- *** IMPORTANT: This is what gets added to your page, with your path to files of course *** -->
   <link rel="stylesheet" href="http://merrow.com/cephei/css/forms/form_a.css" type="text/css" charset="utf-8">
   <link rel="stylesheet" href="http://merrow.com/cephei/css/frontpage/base.css" type="text/css" charset="utf-8">
	<!--<link rel="stylesheet" href="http://merrow.com/cephei/css/nav.css" type="text/css" charset="utf-8"> -->
	<link rel="stylesheet" href="http://merrow.com/cephei/css/ac_quicktime.css"  type="text/css" charset="utf-8">
	<link rel="stylesheet" href="http://merrow.com/cephei/css/frontpage/index.css" type="text/css" charset="utf-8">
    <link rel="stylesheet" href="http://merrow.com/cephei/css/frontpage/whole.css" type="text/css" charset="utf-8">
...
if(file_exists('form.php')) {
    ...
    include_once("../../testpages1/form_folder_agent/$set_directory/form.php"); 
} else if(file_exists('../'.$set_directory.'/form.php')) {
