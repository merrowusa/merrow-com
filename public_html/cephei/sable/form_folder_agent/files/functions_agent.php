...
if(file_exists('files/CONFIG_AGENT.php')) {
    require("files/CONFIG_AGENT.php");
} else if(file_exists('../'.$set_directory.'files/CONFIG_AGENT.php')) {
    require("../$set_directory/files/CONFIG_AGENT.php");
} else if(file_exists('../'.$set_directory.'/files/CONFIG_AGENT.php')) {
    require("../../$set_directory/files/CONFIG_AGENT.php");
} else if(file_exists('../../'.$set_directory.'/files/CONFIG_AGENT.php')) {
    require("../../$set_directory/files/CONFIG_AGENT.php");
    ...
    $user_message = '<div id="results"><p class="error"><strong>Installation Error: The configuration file, CONFIG_AGENT.php, does not exist or cannot be found!</strong></p></div>';
    $form_status  = "nogo";
}
