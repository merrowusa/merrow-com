   ...
   <div id="alt_area" class="lrgMid" style="display: ">
				...
				<!-- here come the optional Alt areas for each country: these are all OFF by default, and 
                     ...
                     <div class="lrgTop">
						...
						<div id="alt_us" >					
							...
							<p class="view"><a href="http://merrow.com/cephei/sable/fp_dynamicstore.php"><? echo $tongue['stitchstore_pric_body11']; ?></a></p>
						</div>
                        	</div>
    ...
    <div id="sub">
	  ...
	  <h2><a href="/index.html"><? echo $tongue['stitchstore_heading']; ?></a></h2>
            ...
            <li><a href="./fp_stitchstore_pricing.php"class="active"><? echo $tongue['stitchstore_menu4']; ?></a></li>
