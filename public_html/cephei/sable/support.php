...
<head>
	...
	<title> <? if ($mval!='key') { ?><? echo $juju['class']; ?> class technical information <? } elseif ($mval = 'key') { ?>
...
The Merrow Sewing Machine <? echo $huhu['msmc_id']; ?> class parts book <? } else { ?> Support pages for Merrow Sewing Machines <? } ?></title>
    ...
    <link href="http://css.imerrow.com/css_major/hoverbox.css" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="http://css.imerrow.com/css_major/lightbox.css" type="text/css" media="screen" />
...
<script language="javascript" type="text/javascript" src="http://merrow.com/cephei/scripts/lightbox.js"></script>
 <script type="text/javascript" src="gz.php?src=http://merrow.com/cephei/scripts/prototype"></script>
