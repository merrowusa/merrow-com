...
<div class="app" id="images"><table width="750px" >
          <tr>
            <td>  <div align="center"><a href="http://merrow.com/cephei/sable/fp_merrow_stitching.php?app=decorative"><img name="tf" src="http://images.imerrow.com/images/act_6.jpg" width="200" height="200" alt="http://images.imerrow.com/images/act.jpg" /></a></div></td><td><div align="center"><a href="http://merrow.com/cephei/sable/fp_merrow_stitching.php?app=finishing"><img name="tf1" src="http://images.imerrow.com/images/act_5.jpg" width="200" height="200" alt="" /></a></div></td><td><div align="center"><a href="http://merrow.com/cephei/sable/fp_merrow_stitching.php?app=seaming"><img name="tf2" src="http://images.imerrow.com/images/act3.jpg" width="200" height="200" alt="" /></a></div></td>
          </tr>
          <tr>
          <td><div id="lilname" align="center"><span> <a href="http://merrow.com/cephei/sable/fp_merrow_stitching.php?app=decorative"><? echo $tongue['application_button_1']; ?></a></span> </div></td>
          <td> <div id="lilname" align="center"><span><a href="http://merrow.com/cephei/sable/fp_merrow_stitching.php?app=finishing"><? echo $tongue['application_button_2']; ?></a></span></div></td>
          <td> <div id="lilname" align="center"><span><a href="http://merrow.com/cephei/sable/fp_merrow_stitching.php?app=seaming"><? echo $tongue['application_button_3']; ?></a></span> </div></td>
        </table>	
      </div>
