...
<div class="edit3"> <a href="http://merrow.com/cephei/sable/widget_config_center_parts.php?placeValuesBeforeTB_=savedValues&TB_iframe=true&height=400&width=700&" title="configure the store by clicking "change" and updating the fields" class="thickbox"><img name="" src="http://images.imerrow.com/images/edit_button.jpg" alt=""></a></div>
</div>
...
<a href="<? echo $url; ?>" ><? echo $advert; ?></a>
    ...
    <div class="edit2"> <a href="http://merrow.com/cephei/sable/widget_config_contactinfo.php?placeValuesBeforeTB_=savedValues&TB_iframe=true&height=400&width=700&" title="configure the store by clicking "change" and updating the fields" class="thickbox"><img name="" src="http://images.imerrow.com/images/edit_button.jpg" alt=""></a></div>       
</div>
...
<p><? echo $agent_store['company_sells']; ?> <br /><br /><? echo $agent_store['company_about']; ?><br /><br /><? echo $agent_store['company_territory']; ?></p>
    ...
    <div class="edit5"> <a href="http://merrow.com/cephei/sable/widget_config_choices.php?placeValuesBeforeTB_=savedValues&TB_iframe=true&height=400&width=700&" title="configure the store by clicking "change" and updating the fields" class="thickbox"><img name="" src="http://images.imerrow.com/images/edit_button.jpg" alt=""></a></div>           
    <div class="list_content">
        <ul class="ordered">
...
or die(mysql_error());
   ...
   ?>          
    ...
    <div class="edit2"> <a href="http://merrow.com/cephei/sable/widget_config_machines.php?placeValuesBeforeTB_=savedValues&TB_iframe=true&height=400&width=700&" title="configure the store by clicking "change" and updating the fields" class="thickbox"><img name="" src="http://images.imerrow.com/images/edit_button.jpg" alt=""></a></div> </div>           
<div class="list_head"><h3><a href="">more products</a></h3></div>
    ...
    <div class="list_foot"><p class="more"><a href="">more&hellip;</a></p>
    <div class="edit2"> <a href="http://merrow.com/cephei/sable/widget_config_choices.php?placeValuesBeforeTB_=savedValues&TB_iframe=true&height=400&width=700&" title="configure the store by clicking "change" and updating the fields" class="thickbox"><img name="" src="http://images.imerrow.com/images/edit_button.jpg" alt=""></a></div> </div>              
