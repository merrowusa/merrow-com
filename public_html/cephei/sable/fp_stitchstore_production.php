  ...
  <div id="content">
							...
							<div class="greyMain">
								<div class="greyTop">
									<div class="greyBtm" 
                                        ...
                                        <form action="http://merrow.com/cephei/sable/fp_contact_general.php?mature=mature" method="post"> 
    ...
    <div id="sub">
	  ...
	  <h2><a href="/index.html"><? echo $tongue['stitchstore_heading']; ?></a></h2>
            ...
            <li><a href="./fp_stitchstore_production.php"class="active"><? echo $tongue['stitchstore_menu2']; ?></a></li>
