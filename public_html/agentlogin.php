...
<!-- ##################  
	 ...
	 ################## -->	 
                    ...
                    Please choose:<a href="http://merrow.com/dynamicstore.php?party_id=<? echo $_GET['party_id']; ?>&choice=<? echo $_GET['choice'];?>&store=65533122844756220294&key=configuration"> edit your store</a> or login to Merrow's <a href="http://merrow.com/agentlogin.php?asap=9931020293383445">order entry system</a> <? } else { ?> 
                    
                  
                 
					
             		<iframe src="http://merrow.com/widget_opentaps.php" height="700" width="980px" scrolling="auto" frameborder="0"/>
