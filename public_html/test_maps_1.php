...
//show code example B
$("a.codeButtonB").click(function(){$("pre.codeEMAIL").toggle()});
 ...
 <div id="detail-stats">
 	<div id="complaints">
    	<span id="complaint-count">
			<? echo "".$retval['emails_sent']; ?></span> Emails Sent <a href=""></a></span>
 		<span class="codebutton"> 
         	<a href="#" class="codeButtonB">Show&nbsp;/&nbsp;Hide Email Campaign</a> </span>
 	</div>
...
<ul class="stats-list">
 ...
 <li> <span class="value"><? echo "".$retval['emails_sent']; ?></span> <span class="name">Total Recipients</span> </li> 
 
 <li> <span class="value"> <? $total = $retval['emails_sent'] - $retval['syntax_errors'] - $retval['hard_bounces'] - $retval['soft_bounces']; echo $total;?> </span> <span class="name">Successful Deliveries</span> </li>
 
  <li> <span class="value"><? echo "".$retval['forwards']; ?></span> <span class="name">Times Forwarded</span> </li> 
  
  <li> <span class="value"><? echo "".$retval['forwards_opens']; ?></span> <span class="name">Forwarded Opens</span> </li>  
  
  <li> <span class="value"> <span class="percent"><? $percopen = $retval['unique_opens'] / $total; $percent = ($percopen *100)." %";  $peroutput = round($percent,2); echo " %" .$peroutput; ?></span> <? echo "".$retval['unique_opens']; ?></span>  <span class="name"><a href="http://merrow.com/chimp_aim.php?choice=1&cid=febf14b72d&height=500&width=300" class="thickbox" title="Opened Email">Recipients Who Opened</a></span> </li>
  
   <li> <span class="value"><? echo "".$retval['opens']; ?></span>  <span class="name">Total Times Opened</span> </li>
   
    <li> <span class="value"><? echo "".$retval['last_open']; ?></span>  <span class="name">Last Open Date</span> </li>
    
     <li> <span class="value"> <span class="percent"></span> <? echo "".$retval['unique_clicks']; ?> </span>  <span class="name">Recipients Who Clicked</span> </li> 
                       
      <li> <span class="value"><? echo "".$retval['clicks']; ?></span>  <span class="name">Total Clicks</span> </li> 
      
   
      <li>   <span class="value"><? if($retval['last_click'] == 0) { echo "none"; } else { echo "".$retval['last_click']; } ?></span>  <span class="name">Last Click Date</span> </li>
   
      
      <li> <span class="value"> <? $didntopen = $total - $retval['unique_opens']; echo $didntopen;?></span>  <span class="name"><a href="http://merrow.com/chimp_aim.php?choice=2&cid=febf14b72d&height=500&width=300" class="thickbox" title="Un-Opened Email">Total Unopened</a></span> </li> 
      
      <li class="last"> <span class="value"><? echo "".$retval['unsubscribes']; ?></span> <span class="name">Total Unsubs</span> </li> </ul>
</pre>

<div class="mapkey"> Map Key: <img name="green" src="http://labs.google.com/ridefinder/images/mm_20_green.png" width="6" height="10" alt="" /> <img name="green" src="http://labs.google.com/ridefinder/images/mm_20_blue.png" width="6" height="10" alt="" /> <img name="green" src="http://labs.google.com/ridefinder/images/mm_20_yellow.png" width="6" height="10" alt="" /> <img name="green" src="http://labs.google.com/ridefinder/images/mm_20_red.png" width="6" height="10" alt="" />
...
?> 
    ...
    function load() {
      if (GBrowserIsCompatible()) {
        ...
        GDownloadUrl("genXML5512128.php?planet=<? echo $parsnip['table']; ?>&merrow=merrow&timeout=<? echo $timeout; ?>", function(data) {
