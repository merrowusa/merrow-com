...
<br clear="all"/>
<div class="headline">The <? echo $machine; ?> is a variation of the <a href="http://merrow.com/70class.php?cp=72d3b2">Merrow 72-D3B-2 </div>
<p>learn more about the 72-D3B-2</p></a>
<? } else { ?>

<br clear="all"/>
<div class="headline">The <? echo $machine; ?> is one of more than 350 variations of the <a href="http://merrow.com/70class.php?cp=70d3b2">Merrow 70-D3B-2 </div>
...
<!-- END OTHER BUTT SEAMING MACHINES CONTENT   -->
               ...
               <!--   SECTION FOR IFRAME CONTENT	-->
        		...
        		<iframe src="http://merrow.com/widget_cp_enventory.php" scrolling="no" frameborder="0" height="500" width="100%" ></iframe> 
