...
$opts['fdd']['key_code'] = array(
  'name'     => 'Key Code (eg. 021511)',
  'select'   => 'T',
  'maxlen'   => 6,
   'options'  => 'CLAPV',
  'sort'     => true
);
$opts['fdd']['img_1_link'] = array(
...
$opts['fdd']['img_2_link'] = array(
  'name'     => 'Right Sidebar Image Link',
  'select'   => 'T',
  'maxlen'   => 100,
   'options'  => 'CLAPV',
  'sort'     => true
);
$opts['fdd']['img_3_link'] = array(
  'name'     => 'Left Footer Rectangle Link',
  'select'   => 'T',
  'maxlen'   => 100,
   'options'  => 'CLAPV',
  'sort'     => true
);
$opts['fdd']['img_4_link'] = array(
  'name'     => 'Right Footer Rectangle Link',
  'select'   => 'T',
  'maxlen'   => 100,
   'options'  => 'CLAPV',
  'sort'     => true
);
$opts['fdd']['main_copy'] = array(
  'name'     => 'Main Copy',
  'select'   => 'T',
  'maxlen'   => 800,
   'options'  => 'CLAPV',
...
$opts['fdd']['main_copy']['textarea']['rows'] = 8;
$opts['fdd']['main_copy']['textarea']['cols'] = 70;

$opts['fdd']['contact_copy'] = array(
  'name'     => 'Contact Line Copy',
  'select'   => 'T',
  'maxlen'   => 100,
   'options'  => 'CLAPV',
...
$opts['fdd']['contact_link'] = array(
  'name'     => 'Contact Link (http://....)',
  'select'   => 'T',
  'maxlen'   => 100,
  'options'  => 'CLAPV',
  'sort'     => true
