...
<ul id="family-mac">
  ...
  <div class="custom_product_width">  
    ...
    <a href="<? if ($keyman=='configuration') { ?>http://merrow.com/cephei/public_images/index.php<? } else { ?>http://merrow.com/widget_custom_store_feature_product.php<? } ?>?location=center&unit=1&unit_on_ur_knees=store1Alpha&party_id=<? echo $party_id; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&<? if ($keyman=='configuration') { ?>height=250&width=600<? } else { ?>height=500&width=400<? } ?>" title="new products available from <? echo $agent_store['name']; ?> "change" and updating the fields" class="thickbox">
   ...
   <div class="custom_product_width">
    <li class="product" id="family-prod-air">
	 <a href="<? if ($keyman=='configuration') { ?>http://merrow.com/cephei/public_images/index.php<? } else { ?>http://merrow.com/widget_custom_store_feature_product.php<? } ?>?location=center&unit=2&unit_on_ur_knees=store1Beta&party_id=<? echo $party_id; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&<? if ($keyman=='configuration') { ?>height=250&width=600<? } else { ?>height=500&width=400<? } ?>" title="new products available from <? echo $agent_store['name']; ?> "change" and updating the fields" class="thickbox"><span>
    ...
    <li class="product" id="family-prod-pro">
		 <a href="<? if ($keyman=='configuration') { ?>http://merrow.com/cephei/public_images/index.php<? } else { ?>http://merrow.com/widget_custom_store_feature_product.php<? } ?>?location=center&unit=3&unit_on_ur_knees=store1Gamma&party_id=<? echo $party_id; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&<? if ($keyman=='configuration') { ?>height=250&width=600<? } else { ?>height=500&width=400<? } ?>" title="new products available from <? echo $agent_store['name']; ?> "change" and updating the fields" class="thickbox">
	...
	<a href="<? if ($keyman=='configuration') { ?>http://merrow.com/cephei/public_images/index.php<? } else { ?>http://merrow.com/widget_custom_store_feature_product.php<? } ?>?location=center&unit=4&unit_on_ur_knees=store1Delta&party_id=<? echo $party_id; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&<? if ($keyman=='configuration') { ?>height=250&width=600<? } else { ?>height=500&width=400<? } ?>" title="new products available from <? echo $agent_store['name']; ?> "change" and updating the fields" class="thickbox"><span>
...
<? if ($keyman=='configuration') { ?> <div class="edit3"> <a href="http://merrow.com/widget_config_center_parts.php?party_id=<? echo $party_id; ?>&dbname=<? echo $agents['city']; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&<? if ($keyman=='configuration') { ?>height=250&width=600<? } else { ?>height=400&width=800<? } ?>" title="configure the store by clicking "change" and updating the fields" class="thickbox"><img name="" src="http://images.imerrow.com/images/edit_button.jpg" alt=""></a></div> <? } ?>
</div>
...
<a href="<? echo $url; ?>" ><? echo $agent_store['custom_center_product5_name'];?></a>
 ...
 <dd class="image">
 <a href="<? if ($keyman=='configuration') { ?>http://merrow.com/cephei/public_images/index.php<? } else { ?>http://merrow.com/widget_custom_store_feature_product.php<? } ?>?location=center&unit=5&unit_on_ur_knees=store5&party_id=<? echo $party_id; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&<? if ($keyman=='configuration') { ?>height=250&width=600<? } else { ?>height=500&width=400<? } ?>" title="new products available from <? echo $agent_store['name']; ?> "change" and updating the fields" class="thickbox">
...
<a href="<? echo $url; ?>" ><? echo $agent_store['custom_center_product6_name'];?></a>
 ...
 <dd class="image">
 <a href="<? if ($keyman=='configuration') { ?>http://merrow.com/cephei/public_images/index.php<? } else { ?>http://merrow.com/widget_custom_store_feature_product.php<? } ?>?location=center&unit=6&unit_on_ur_knees=store6&party_id=<? echo $party_id; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&<? if ($keyman=='configuration') { ?>height=250&width=600<? } else { ?>height=500&width=400<? } ?>" title="new products available from <? echo $agent_store['name']; ?> "change" and updating the fields" class="thickbox">
...
<dt class="name">
 ...
 <dd class="image">
 <a href="<? if ($keyman=='configuration') { ?>http://merrow.com/cephei/public_images/index.php<? } else { ?>http://merrow.com/widget_custom_store_feature_product.php<? } ?>?location=center&unit=7&unit_on_ur_knees=store7&party_id=<? echo $party_id; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&<? if ($keyman=='configuration') { ?>height=250&width=600<? } else { ?>height=500&width=400<? } ?>" title="new products available from <? echo $agent_store['name']; ?> "change" and updating the fields" class="thickbox">
...
<a href="<? echo $url; ?>" ><? echo $agent_store['custom_center_product8_name'];?></a>
 ...
 <dd class="image">
 <a href="<? if ($keyman=='configuration') { ?>http://merrow.com/cephei/public_images/index.php<? } else { ?>http://merrow.com/widget_custom_store_feature_product.php<? } ?>?location=center&unit=8&unit_on_ur_knees=store8&party_id=<? echo $party_id; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&<? if ($keyman=='configuration') { ?>height=250&width=600<? } else { ?>height=500&width=400<? } ?>" title="new products available from <? echo $agent_store['name']; ?> "change" and updating the fields" class="thickbox">
...
<a href="<? echo $url; ?>" ><? echo $agent_store['custom_center_product9_name'];?></a>
 ...
 <dd class="image">
 <a href="<? if ($keyman=='configuration') { ?>http://merrow.com/cephei/public_images/index.php<? } else { ?>http://merrow.com/widget_custom_store_feature_product.php<? } ?>?location=center&unit=9&unit_on_ur_knees=store9&party_id=<? echo $party_id; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&<? if ($keyman=='configuration') { ?>height=250&width=600<? } else { ?>height=500&width=400<? } ?>" title="new products available from <? echo $agent_store['name']; ?> "change" and updating the fields" class="thickbox">
...
<a href="<? echo $url; ?>" ><? echo $agent_store['custom_center_product10_name'];?></a>
 ...
 <dd class="image">
 <a href="<? if ($keyman=='configuration') { ?>http://merrow.com/cephei/public_images/index.php<? } else { ?>http://merrow.com/widget_custom_store_feature_product.php<? } ?>?location=center&unit=10&unit_on_ur_knees=store10&party_id=<? echo $party_id; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&<? if ($keyman=='configuration') { ?>height=250&width=600<? } else { ?>height=500&width=400<? } ?>" title="new products available from <? echo $agent_store['name']; ?> "change" and updating the fields" class="thickbox">
...
<a href="<? echo $url; ?>" ><? echo $agent_store['custom_center_product11_name'];?></a>
 ...
 <dd class="image">
 <a href="<? if ($keyman=='configuration') { ?>http://merrow.com/cephei/public_images/index.php<? } else { ?>http://merrow.com/widget_custom_store_feature_product.php<? } ?>?location=center&unit=11&unit_on_ur_knees=store11&party_id=<? echo $party_id; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&<? if ($keyman=='configuration') { ?>height=250&width=600<? } else { ?>height=500&width=400<? } ?>" title="new products available from <? echo $agent_store['name']; ?> "change" and updating the fields" class="thickbox">
...
<a href="<? echo $url; ?>" ><? echo $agent_store['custom_center_product12_name'];?></a>
 ...
 <dd class="image">
 <a href="<? if ($keyman=='configuration') { ?>http://merrow.com/cephei/public_images/index.php<? } else { ?>http://merrow.com/widget_custom_store_feature_product.php<? } ?>?location=center&unit=12&unit_on_ur_knees=store12&party_id=<? echo $party_id; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&<? if ($keyman=='configuration') { ?>height=250&width=600<? } else { ?>height=500&width=400<? } ?>" title="new products available from <? echo $agent_store['name']; ?> "change" and updating the fields" class="thickbox">
...
<a href="<? echo $url; ?>" ><? echo $advert; ?></a>
	...
	<? if ($keyman=='configuration') { ?>  <div class="edit2"> <a href="http://merrow.com/widget_config_center_products.php?party_id=<? echo $party_id; ?>&dbname=<? echo $agents['city']; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=400&width=700&" title="configure the store by clicking "change" and updating the fields" class="thickbox"><img name="" src="http://images.imerrow.com/images/edit_button.jpg" alt=""></a></div>  <? } ?>					
...
<p><? echo $agent_store['company_sells']; ?> <br /><br /><? echo $agent_store['company_about']; ?><br /><br /><? echo $agent_store['company_territory']; ?></p>
    	...
    	<? if ($keyman=='configuration') { ?>   <div class="edit4"> <a href="http://merrow.com/widget_config_description.php?party_id=<? echo $party_id; ?>&dbname=<? echo $agents['city']; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=400&width=700&" title="configure the store by clicking "change" and updating the fields" class="thickbox"><img name="" src="http://images.imerrow.com/images/edit_button.jpg" alt=""></a></div>  <? } ?>		       
</div>
	<div class="module_btm">&nbsp;</div>
					</div>
    ...
    <? if ($keyman=='configuration') { ?>   <div class="edit5"> <a href="http://merrow.com/widget_config_catalog.php?party_id=<? echo $party_id; ?>&dbname=<? echo $agents['city']; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=400&width=700&" title="configure the store by clicking "change" and updating the fields" class="thickbox"><img name="" src="http://images.imerrow.com/images/edit_button.jpg" alt=""></a></div>  <? } ?>		
    <div class="list_content">
        <ul class="ordered">
...
<div class="list_content">
        ...
        <? if ($keyman=='configuration') { ?>   <div class="edit1"> <a href="http://merrow.com/widget_config_contactinfo.php?party_id=<? echo $party_id; ?>&dbname=<? echo $agents['city']; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=400&width=700&" title="configure the store by clicking "change" and updating the fields" class="thickbox"><img name="" src="http://images.imerrow.com/images/edit_button.jpg" alt=""></a></div>  <? } ?>		
...
or die(mysql_error());
   ...
   ?>          
    ...
    <? if ($keyman=='configuration') { ?>   <div class="edit2"> <a href="http://merrow.com/widget_config_machines.php?party_id=<? echo $party_id; ?>&dbname=<? echo $agents['city']; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=400&width=700&" title="configure the store by clicking "change" and updating the fields" class="thickbox"><img name="" src="http://images.imerrow.com/images/edit_button.jpg" alt=""></a></div>  <? } ?>		</div>    
<div class="list_head"><h3><a href="">more products</a></h3></div>
    <div class="list_content">
        <ul>
            
    <? if ($agent_store['custom_product1_name']!=null) { ?>  <li> <a href="http://merrow.com/widget_custom_store_feature_product.php?location=column&unit=1&unit_on_ur_knees=store13&party_id=<? echo $agents['party_id']; ?>&suixname=<? echo $agents['city']; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=500&width=500" title="new products available from <? echo $agent_store['name']; ?> "change" and updating the fields" class="thickbox"><? echo $agent_store['custom_product1_name']; ?></a></li><? } ?>
         <? if ($agent_store['custom_product2_name']!=null) { ?> <li><a href="http://merrow.com/widget_custom_store_feature_product.php?location=column&unit=2&unit_on_ur_knees=store14&party_id=<? echo $agents['party_id']; ?>&suixname=<? echo $agents['city']; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=500&width=500" title="new products available from <? echo $agent_store['name']; ?> "change" and updating the fields" class="thickbox"><? echo $agent_store['custom_product2_name']; ?></a></li><? } ?>
            <? if ($agent_store['custom_product3_name']!=null) { ?> <li><a href="http://merrow.com/widget_custom_store_feature_product.php?location=column&unit=3&unit_on_ur_knees=store15&party_id=<? echo $agents['party_id']; ?>&suixname=<? echo $agents['city']; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=500&width=500" title="new products available from <? echo $agent_store['name']; ?> "change" and updating the fields" class="thickbox"><? echo $agent_store['custom_product3_name']; ?></a></li><? } ?>
              <? if ($agent_store['custom_product4_name']!=null) { ?>  <li><a href="http://merrow.com/widget_custom_store_feature_product.php?location=column&unit_on_ur_knees=store16&unit=4&party_id=<? echo $agents['party_id']; ?>&suixname=<? echo $agents['city']; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=500&width=500" title="new products available from <? echo $agent_store['name']; ?> "change" and updating the fields" class="thickbox"><? echo $agent_store['custom_product4_name']; ?></a></li><? } ?>
                 <? if ($agent_store['custom_product5_name']!=null) { ?>  <li><a href="http://merrow.com/widget_custom_store_feature_product.php?location=column&unit_on_ur_knees=store17&unit=5&party_id=<? echo $agents['party_id']; ?>&suixname=<? echo $agents['city']; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=500&width=500" title="new products available from <? echo $agent_store['name']; ?> "change" and updating the fields" class="thickbox"><? echo $agent_store['custom_product5_name']; ?></a></li><? } ?>
                    <? if ($agent_store['custom_product6_name']!=null) { ?>  <li><a href="http://merrow.com/widget_custom_store_feature_product.php?location=column&unit=6&unit_on_ur_knees=store18&party_id=<? echo $agents['party_id']; ?>&suixname=<? echo $agents['city']; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=500&width=500" title="new products available from <? echo $agent_store['name']; ?> "change" and updating the fields" class="thickbox"><? echo $agent_store['custom_product6_name']; ?></a></li><? } ?>
                       <? if ($agent_store['custom_product7_name']!=null) { ?>  <li><a href="http://merrow.com/widget_custom_store_feature_product.php?location=column&unit=7&unit_on_ur_knees=store19&party_id=<? echo $agents['party_id']; ?>&suixname=<? echo $agents['city']; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=500&width=500" title="new products available from <? echo $agent_store['name']; ?> "change" and updating the fields" class="thickbox"><? echo $agent_store['custom_product7_name']; ?></a></li><? } ?>
                          <? if ($agent_store['custom_product8_name']!=null) { ?>  <li><a href="http://merrow.com/widget_custom_store_feature_product.php?location=column&unit=8&unit_on_ur_knees=store20&party_id=<? echo $agents['party_id']; ?>&suixname=<? echo $agents['city']; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=500&width=500" title="new products available from <? echo $agent_store['name']; ?> "change" and updating the fields" class="thickbox"><? echo $agent_store['custom_product8_name']; ?></a></li><? } ?>
    ...
    <div class="list_foot"><p class="more"><a href="">more&hellip;</a></p>
    <? if ($keyman=='configuration') { ?>   <div class="edit2"> <a href="http://merrow.com/widget_config_column_parts.php?party_id=<? echo $party_id; ?>&dbname=<? echo $agents['city']; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=400&width=700&" title="configure the store by clicking "change" and updating the fields" class="thickbox"><img name="" src="http://images.imerrow.com/images/edit_button.jpg" alt=""></a></div><div class="edit6"> <a href="http://merrow.com/widget_sub_config_multipic.php?party_id=<? echo $party_id; ?>&location=column&dbname=<? echo $agents['city']; ?>&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=500&width=700&" title="configure the store by clicking "change" and updating the fields" class="thickbox"><img name="" src="http://images.imerrow.com/images/binocs.jpg" alt=""><br>add images</a></div>  <? } ?>		</div>  
