...
<head>
	...
	<title>Merrow Applications</title>
	...
	<meta name="viewport" content="width=1024">
     ...
     <? if ($drhorrible == 'test1') { ?>
       ...
       href="http://spreadsheets.google.com/feeds/list/pU2gnfbGev3LWSW_baktCLQ/od6/public/basic?alt=json-in-script"
       ex:converter="googleSpreadsheets" />
      
    
 <? } elseif ($drhorrible =='test2') {?> 
    
      	<link rel="exhibit/data" 
       type="application/jsonp"
       href="http://spreadsheets.google.com/feeds/list/pU2gnfbGev3JOvlUBJV9_SA/od6/public/basic?alt=json-in-script"
       ex:converter="googleSpreadsheets" />
      
        
 <? } elseif ($drhorrible =='test3') {?>
...
<div class="topblock"> 
    ...
    <div class="cunthair"> <a href="https://spreadsheets.google.com/a/imerrow.com/ccc?key=pU2gnfbGev3JOvlUBJV9_SA&hl=en">EDIT CURRENT DATA SOURCE</a> <br>
      <a href="http://merrow.com/sandbox_management.php">EDIT CURRENT FIELD SOURCE</a> </div></div>
...
#
mysql_connect("localhost", "merrowco_creeper", "merr0w") or die(mysql_error());

#
mysql_select_db("merrowco_rollingthunder") or die(mysql_error());



   // Get all the data from the "asin" table which is where our product info is kept
$result1 = mysql_query("SELECT * FROM sandbox_management WHERE application='$drhorrible'")
or die(mysql_error());



// then define juju as the result array
 $spitballs = mysql_fetch_array($result1); 
 ...
 ?>				
        ...
        <h2><a href=""><? echo $spitballs['left_box1']; ?> </a></h2>
...
// then define juju as the result array
 ...
 ?>				
  ...
  <div class="stitches" id="secondset">
 <div class="little" id="label"> <p><? echo $spitballs['left_box_sub1']; ?></p></div>
 
    <div ex:role="facet" ex:expression=".Threadname" ex:height="300px"  ex:showMissing="false" ex:facetLabel="<? echo $spitballs['left_box2']; ?>"></div>
 <div ex:role="facet" ex:expression=".Threadweight" ex:showMissing="false" ex:collapsed="false"  ex:height="500px" ex:facetLabel="<? echo $spitballs['left_box3']; ?>"></div>
...
<!-- ##################  
	...
	// ################## -->	 
                ...
                <div class="trap">
                  ...
                  <div id="content">
                  <div class="header"> The <? echo $spitballs['parent']; ?> Application Configurator </div><div class="searchbarnote">search apps</div>
  ...
  <a class="thickbox" 
     ...
     <img ex:src-subcontent="http://images.imerrow.com/images/nano/{{.nano4}}.jpg" alt=""/></a></div>
               ...
               <td> 
                 ...
                 <div class="boxes"
                 <div class="charlie">
                                     <div ex:if-exists=".Colors" class="co-winners"><? echo $spitballs['center_line1']; ?>: 
                               <span ex:content=".Amount"></span></div>
                                     <div ex:if-exists=".Needle Type" class="discipline"><? echo $spitballs['center_line2']; ?>: 
                               <span ex:content=".Application"></span></div>
                               <div ex:if-exists=".Material" class="year"><? echo $spitballs['center_line3']; ?>: 
                               <span ex:content=".Material"></span></div>
                                <a nancy="thickbox" ex:href-subcontent="http://merrow.com/contact_general/label/{{.label}}/key/samples"> 
...
//	 ################## -->	 	
        ...
        <h2><a href=""><? echo $spitballs['right_box1']; ?></a></h2>
   
   <div id="wheretobuypromo"></div>

  <div class="stitches" id="secondset">
 <div class="little" id="label"> <p><? echo $spitballs['right_box2']; ?></p></div>
 
 
            
              <div ex:role="facet" ex:expression=".Application" ex:showMissing="false" ex:collapsed="false"ex:facetLabel="<? echo $spitballs['right_box3']; ?>"></div>
              <br><span> <h2> <? echo $tongue['decorative_edging_sort']; ?> </h2> </span><br>
               <div ex:role="facet" ex:expression=".Amount"  ex:height="300px" ex:showMissing="false" ex:collapsed="false" ex:facetLabel="<? echo $spitballs['right_box4']; ?>"></div> 
                   <div ex:role="facet" ex:expression=".Material"  ex:height="300px" ex:showMissing="false" ex:collapsed="false" ex:facetLabel="<? echo $spitballs['right_box5']; ?>"></div> 
