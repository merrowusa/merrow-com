<!-- INSTRUCTION 
1. REPLACE DATES WHERE SRC ="http://merrow-media.s3....." WITH NEW MAIL DATES eg. http://merrow-media.s3.amazonaws.com/mail-media/   022211   /mail_06.jpg
...
<a target="_self" href="http://merrow.com/mkt_mail_y3b2.html" class="" title="">click here</a>
...
src="http://merrow-media.s3.amazonaws.com/mail-media/022211/mail_03.gif" class="" height="24"></a></TD></TR><TR ><TD height=5 ><TABLE cellSpacing=0 cellPadding=0 width=0 summary="" border=0 ><TBODY>
...
<!-- TOP IMAGE LINK -->
<a target="_self" href="http://www.merrow.com/Overlock_Sewing_Machines/Continuous_Processing/70y3b2" class="" title="">
<!-- END TOP IMAGE LINK --> 

<img border="0" vspace="0px" hspace="0" width="600" alt="merrow mail image 1" src="http://merrow-media.s3.amazonaws.com/mail-media/022211/mail_06.jpg" class="" height="420"></a></TD></TR></TBODY></TABLE></TD></TR><TR ><TD height=5 ></TD></TR><TR ><TD height=10 ></TD></TR><TR >

<TD ><TABLE cellSpacing=0 cellPadding=0 width=600 align=left summary="" border=0 >
<TBODY><TR ><TD vAlign=top width=400 ><p><font face="Verdana, Arial, Helvetica, sans-serif" size=2  ><img border="0" alt="merrow mail image 2" vspace="0px" align="top" height="53" src="http://merrow-media.s3.amazonaws.com/mail-media/022211/mail_09.gif" hspace="0" width="359" class=""></font></p><p><font face="Verdana, Arial, Helvetica, sans-serif" size=2  >

<!-- BODY TEXT -->
The Merrow 70-Y3B-2 has been a staple of the Merrow End-to-End Seaming line for decades.  It has ingrained itself in the denim industry because of its capability to double the stitch count at fabric selvages, but can be used for any application where additional seam strength is required.  It sews the same stitch as Merrow's flagship 70-D3B-2 (a flat 5/8" butted seam), but with the press of a lever will double the stitch count on command.  For as low as $1770*, you can get the durability and reliability of the 70-D3B-2, but double the sewing performance!  IN STOCK NOW!!! 
