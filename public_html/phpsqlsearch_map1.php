  ...
  function createSidebarEntry(marker, name, address, distance) {
	...
	function searchLocations() {
     ...
     geocoder.getLatLng(address, function(latlng) {
       if (!latlng) {
         alert(address + ' Charlie! not found');
       } else {
    ...
    <div id="hd">
        ...
        <form action="http://maps.google.com/maps" id="geocodeForm">
            <p>
                ...
                <input type="submit" onclick="searchLocations()" value="Zoom to place">
            </p>
        </form>
    </div>
    <div id="bd">
    	<div id="sidebar" style="overflow: auto; height: 200px; width: 200px; font-size: 11px; color: #000"></div>
		 <div id="gmap"></div>
