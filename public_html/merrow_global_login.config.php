...
define('SUCCESS_URL',	"THIS IS NOT BEING USED IT IS REPLACED BY A THE FOLLOW VARIABLE FOLLOW ON THE PREVIOUS PAGE");		//@ redirection target on success
...
if(USEDB) 
	{
		$db_config = array(
				...
				'tbl_user'	=>	'login_auth_global'		//@ user table name
			);
