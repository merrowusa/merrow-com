...
$opts['fdd']['publish'] = array(
  'name'     => 'Publish this Application',
  'maxlen'   => 3,
  'default'  => '0',
   'options'  => 'ALCPVDF',
  'sort'     => true
);
$opts['fdd']['app_key'] = array(
  'name'     => 'application key',
  'maxlen'   => 5,
   'options'  => 'LACPVDF',
  'sort'     => true
);
$opts['fdd']['d_key'] = array(
  'name'     => 'MEDIA key',
  'maxlen'   => 50,
   'options'  => 'LACPVDF',
  'sort'     => true
...
$opts['fdd']['layout_order'] = array(
  'name'     => 'Layout Order',
  'maxlen'   => 2,
   'options'  => 'LACPVDF',
  'sort'     => true
);
$opts['fdd']['app_nav_title'] = array(
  'name'     => 'Application NAV Title',
  'maxlen'   => 100,
  'default'  => '0',
   'options'  => 'LACPVDF',
  'sort'     => true
);
$opts['fdd']['app_menu_title'] = array(
  'name'     => 'Application  MAIN MENU Title',
  'maxlen'   => 100,
  'default'  => '0',
   'options'  => 'LACPVDF',
  'sort'     => true
);
$opts['fdd']['seo_description'] = array(
...
$opts['fdd']['popup_1stcolumn'] = array(
  'name'     => 'Popup First Column',
  'maxlen'   => 600,
  'default'  => '0',
   'options'  => 'ACPVDF',
  'sort'     => true
);
$opts['fdd']['popup_1stcolumn']['textarea']['rows'] = 3;
$opts['fdd']['popup_1stcolumn']['textarea']['cols'] = 90;



$opts['fdd']['popup_2ndcolumn'] = array(
  'name'     => 'Popup Second Column',
  'maxlen'   => 600,
  'default'  => '0',
   'options'  => 'ACPVDF',
  'sort'     => true
...
$opts['fdd']['popup_2ndcolumn']['textarea']['rows'] = 3;
$opts['fdd']['popup_2ndcolumn']['textarea']['cols'] = 90;




$opts['fdd']['app_right_title'] = array(
  'name'     => 'App Title (right side)',
  'maxlen'   => 200,
  'default'  => '0',
   'options'  => 'ACPVDF',
  'sort'     => true
);
$opts['fdd']['app_right_p'] = array(
  'name'     => 'App Right Paragraph',
  'maxlen'   => 400,
  'default'  => '0',
   'options'  => 'ACPVDF',
  'sort'     => true
...
$opts['fdd']['app_right_p']['textarea']['rows'] = 13;
$opts['fdd']['app_right_p']['textarea']['cols'] = 90;
...
$opts['fdd']['fabric_material'] = array(
  'name'     => 'Material (fabric type)',
  'maxlen'   => 200,
  'default'  => '0',
   'options'  => 'ACPVDF',
  'sort'     => true
);
$opts['fdd']['thread_number'] = array(
  'name'     => 'Number of threads on stitch',
  'maxlen'   => 200,
  'default'  => '0',
   'options'  => 'ACPVDF',
  'sort'     => true
);
$opts['fdd']['thread_material'] = array(
  'name'     => 'Thread Materials',
  'maxlen'   => 200,
  'default'  => '0',
   'options'  => 'ACPVDF',
  'sort'     => true
);
$opts['fdd']['machine_model'] = array(
  'name'     => 'Machine Model',
  'maxlen'   => 200,
  'default'  => '0',
   'options'  => 'LACPVDF',
