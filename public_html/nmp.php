...
?>
  <a href="/a.php?app=<?echo $nate2['app_key']; ?>&#<? echo $nate2['d_key']; ?>"><<? echo  "img src=\"http://merrow-media.s3.amazonaws.com/applications/".$nate2['d_key']; ?>_main_400x360.jpg" width="200px"/></a>
<? } ?>
</div>
<br><br>
<? } ?> 
...
<div class="clear"></div>
<br>
<? if ($nate['page_key'] == '70') { include 'widget_merrow_advantage.php'; } else { include 'widget_merrow_overlock_advantage.php'; } ?>
