...
<script type="text/javascript">
 ...
 //<![CDATA[
    ...
    function load() {
     ...
     var searchUrl = 'phpsqlsearch_genxml.php?lat=' + google.loader.ClientLocation.latitude + '&lng=' + google.loader.ClientLocation.longitude + '&radius=200';
