...
Merrow Market Analysis is a sophisticated tool that allows our agents to more effectively service and support the global market. 
...
<input type="submit"  class="form_buttons1" value="Login" name="submit">
<? if ($key==blubbersnot) { ?>
