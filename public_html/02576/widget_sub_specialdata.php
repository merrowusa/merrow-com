...
$hoorequiredurl="http://merrow.com/market_analysis.php?key=missedafield";
$heerequiredurl="http://merrow.com/market_analysis.php?key=badcaptcha";
$haarequiredurl="http://merrow.com/market_analysis.php?key=wrongpassword";
$hiirequiredurl="http://merrow.com/textile_plants.php?8787=$name_field&33950019334xxlmmnot=$email_field&908234klsdfzwe38hna9f7s=$message99";
$body = "Testing";
...
if ($parsnip['table']==null) {header("Location: $haarequiredurl"); } else { header("Location: $hiirequiredurl"); } } 
?>
