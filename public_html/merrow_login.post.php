...
define('follow', 'widget_opentaps.php?'.$_COOKIE['tmpagent'].'&choice='.$_COOKIE['tmpchoice'].'&store=65533122844756220294&key=configuration');
/*
...
require('merrow_login.config.php');
require('merrow_login.lang.php');
require('merrow_login.class.php');
